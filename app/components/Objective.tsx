...
export default function Objective() {
    return (
        <div className="flex flex-col gap-4 sm:gap-6 w-full">
            {/* Card 1: What I do */}
            <div className="relative flex items-start gap-4 p-4 sm:p-6 rounded-2xl bg-slate-800/40 border border-slate-700/50 backdrop-blur-md transition-all duration-400 ease-out hover:translate-x-2 hover:border-teal-500/30 hover:bg-slate-800/80 hover:shadow-2xl hover:shadow-teal-900/10 group before:absolute before:left-0 before:top-0 before:bottom-0 before:w-[3px] before:bg-teal-400 before:scale-y-0 before:origin-center hover:before:scale-y-100 before:transition-transform before:duration-400 before:ease-out overflow-hidden">
                <div className="shrink-0 w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-teal-500/10 flex items-center justify-center text-teal-400 font-mono text-base sm:text-lg font-semibold mt-0.5 group-hover:bg-teal-500/20 transition-colors">
                    ◇
                </div>
                <div>
                    <h3 className="text-base-1 font-semibold text-lg sm:text-[1.1rem] mb-3 tracking-wide">What I do</h3>
                    <ul className="text-base-2 text-sm sm:text-[0.95rem] space-y-2.5">
            ...
            <div className="relative flex items-start gap-4 p-4 sm:p-6 rounded-2xl bg-slate-800/40 border border-slate-700/50 backdrop-blur-md transition-all duration-400 ease-out hover:translate-x-2 hover:border-sky-500/30 hover:bg-slate-800/80 hover:shadow-2xl hover:shadow-sky-900/10 group before:absolute before:left-0 before:top-0 before:bottom-0 before:w-[3px] before:bg-sky-400 before:scale-y-0 before:origin-center hover:before:scale-y-100 before:transition-transform before:duration-400 before:ease-out overflow-hidden">
                <div className="shrink-0 w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-sky-500/10 flex items-center justify-center text-sky-400 font-mono text-base sm:text-lg font-semibold mt-0.5 group-hover:bg-sky-500/20 transition-colors">
                    △
                </div>
                <div>
                    <h3 className="text-base-1 font-semibold text-lg sm:text-[1.1rem] mb-3 tracking-wide">Experience</h3>
                    <ul className="text-base-2 text-sm sm:text-[0.95rem] space-y-2.5">
            ...
            <div className="relative flex items-start gap-4 p-4 sm:p-6 rounded-2xl bg-slate-800/40 border border-slate-700/50 backdrop-blur-md transition-all duration-400 ease-out hover:translate-x-2 hover:border-indigo-500/30 hover:bg-slate-800/80 hover:shadow-2xl hover:shadow-indigo-900/10 group before:absolute before:left-0 before:top-0 before:bottom-0 before:w-[3px] before:bg-indigo-400 before:scale-y-0 before:origin-center hover:before:scale-y-100 before:transition-transform before:duration-400 before:ease-out overflow-hidden">
                <div className="shrink-0 w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-indigo-500/10 flex items-center justify-center text-indigo-400 font-mono text-base sm:text-lg font-semibold mt-0.5 group-hover:bg-indigo-500/20 transition-colors">
                    ○
                </div>
                <div>
                    <h3 className="text-base-1 font-semibold text-lg sm:text-[1.1rem] mb-3 tracking-wide">Focus</h3>
                    <ul className="text-base-2 text-sm sm:text-[0.95rem] space-y-2.5">
